									...
									<div class="form-group">
										...
										* </span>
										...
										<div class="col-md-7">
											<div class="input-icon right">
												<i class="fa"></i>
												<input type="text" class="form-control" id="scst_no_of_post" name="scst_no_of_post"/>
											</div>
										</div>
									</div>
									...
									<div class="form-group">
										...
										* </span>
										...
										<div class="col-md-7">
											<div class="input-icon right">
												<i class="fa"></i>
												<input type="text" class="form-control" id="obc_no_of_post" name="obc_no_of_post"/>
											</div>
										</div>
									</div>
									...
									<div class="form-group">
										...
										* </span>
										...
										<div class="col-md-4">
											<div class="input-icon right">
												<i class="fa"></i>
												{!!  Form::text('exp_reqp', Input::old('exp_req'), array('class' => 'form-control'),array('placeholder' => 'Experience Required'),array('id' => 'exp_reqp'))!!}
											</div>
										</div>
									</div>
