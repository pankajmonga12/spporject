...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		...
		<div class="modal fade" id="change-qualification" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
					...
					<?php //echo $this->session->flashdata('error_msg'); ?>
						<div class="portlet-title">
							<div class="caption font-red-sunglo">
								...
								<span class="caption-subject bold uppercase"> CHANGE QUALIFICATON</span>
							</div>
							...
							<form action="/changeeligibility" id="changepasswordform" class="form-horizontal"  method="POST">
								<div class="form-body">
									...
									<div class="form-group">
										<label class="control-label col-md-3">New Qualification <span class="required">
										* </span>
										</label>
										<div class="col-md-7">
									...
									<div class="form-group">
										...
										* </span>
										...
										<div class="col-md-4">
											<div class="input-icon right">
												<i class="fa"></i>
												{!!  Form::text('title', Input::old('title'), array('class' => 'form-control'),array('placeholder' => 'New Qualification')) !!}
											</div>
										</div>
									</div>
...
<script type="text/javascript">
	function changeQualification(qValue , id) {

    document.getElementById('qualification').value = qValue;
    document.getElementById('qid').value = id;
		$('#change-qualification').modal('show');
	}
</script>